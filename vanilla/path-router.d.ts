...
declare const ROUTEPROPERTY_DATA_ATTRIBUTE_KEYWORD = "property";
...
export { COMPONENT_TAG_NAME, type PathRouterAttributes, PathRouterElement, PathRouterEvent, ROUTEPROPERTY_DATA_ATTRIBUTE_KEYWORD };
